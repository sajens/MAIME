/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:MaimeGui"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace MaimeGui.ViewModel
{
    ...
    /// </summary>
    /// Generated by MVVM light library, adjusted to fit current application
    public class ViewModelLocator
    {
        ...
        public RepairViewModel Repair
        {
            get
            {
                return ServiceLocator.Current.GetInstance<RepairViewModel>();
            }
        }
    }
}